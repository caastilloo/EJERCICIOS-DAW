...
public class AppMutxaAwards {
    ...
    static void main() {
        ...
        presentado1.darDiscursos("para solidarizarse con los afectados de la DANA.");
        System.out.println();
...
//        System.out.println();
        ...
        artista1.darDiscursos("sobre el esfuerzo realizado para rodar la película.");
        System.out.println();
        ...
        presentado1.darDiscursos("para introducir el siguiente premio: MEJOR_PELICULA");
        System.out.println();
        ...
        artista5.darDiscursos("sobre lo duro que ha sido conseguir financioción.");
        System.out.println();

        presentado1.darDiscursos("para despedir la gala.");
        System.out.println();
